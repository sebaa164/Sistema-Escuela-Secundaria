...
@section('title', 'Mi Horario - Profesor')
...
<div class="container-fluid">
    ...
    <div class="page-header-dark mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <p class="header-subtitle mb-0">Horario semanal de mis secciones</p>
            </div>
            <div class="d-flex gap-2">
                <a href="{{ route('profesor.horario.pdf') }}" class="btn-action-neon" target="_blank">
                ...
                <div class="summary-content-sm">
                    @php
                        ...
                        foreach($secciones as $seccion) {
                            $totalHoras += $seccion->curso->horas_semanales ?? 0;
                        }
                    @endphp
                    <h4>{{ $totalHoras }}</h4>
                    <p>Horas Semanales</p>
            ...
            <div class="summary-card-sm">
                ...
                <div class="summary-content-sm">
                    @php
                        $totalEstudiantes = 0;
                        foreach($secciones as $seccion) {
                            $totalEstudiantes += $seccion->estudiantes->count();
                        }
                    @endphp
                    ...
                    <div class="schedule-body">
                        ...
                        @empty
                            <div class="empty-schedule">
                                ...
                                <p>Aún no se han asignado horarios a tus secciones</p>
                            </div>
                        @endforelse
                    </div>
                </div>
    ...
    <div class="card-dark mt-4">
        <div class="card-header-dark">
            <h5><i class="fas fa-list me-2"></i>Detalle de Secciones</h5>
        </div>
                    ...
                    <div class="col-md-6">
                        <div class="subject-detail-card">
                            <div class="subject-header">
                                <div class="subject-icon" style="background: {{ $coloresSecciones[$seccion->codigo_seccion] ?? '#0ea5e9' }}">
                                    <i class="fas fa-chalkboard"></i>
                                </div>
                            ...
                            <div class="subject-details">
                                <div class="detail-row">
                                    <i class="fas fa-users"></i>
                                    <span>{{ $seccion->estudiantes->count() }} estudiantes inscritos</span>
                                </div>
                                <div class="detail-row">
                                    <i class="fas fa-users"></i>
                                    <span>Cupo máximo: {{ $seccion->cupo_maximo }}</span>
                                </div>
                                <div class="detail-row">
                                    <i class="fas fa-clock"></i>
                                ...
                                <div class="detail-row">
                                    ...
                                    <span>{{ $seccion->curso->creditos ?? 0 }} créditos</span>
                                </div>
                            </div>
