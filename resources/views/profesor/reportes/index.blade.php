...
@section('title', 'Reportes - Profesor')
...
<div class="container-fluid">
    ...
    <div class="page-header mb-4">
        ...
        <p class="page-subtitle">Visualiza y genera reportes detallados de tus secciones</p>
    </div>

    <!-- Grid de Reportes -->
    <div class="reports-grid">
        <!-- Reporte de Calificaciones por Sección -->
        <div class="report-card">
            ...
            <div class="report-content">
                ...
                <p>Estadísticas de calificaciones y promedios por evaluación y sección</p>
                <div class="report-stats">
                    <span class="stat-item">
                        <i class="fas fa-star"></i>
                        {{ \App\Models\Calificacion::whereHas('evaluacion.seccion', function($q) {
                            $q->where('profesor_id', auth()->user()->profesor->id);
                        })->count() }} Calificaciones
                    </span>
                </div>
            </div>
            <div class="report-actions">
                <a href="{{ route('profesor.reportes.calificaciones') }}" class="btn-neon-sm">
        ...
        <div class="report-card">
            ...
            <div class="report-content">
                ...
                <p>Control de asistencia y porcentajes por estudiante y sección</p>
                <div class="report-stats">
                    <span class="stat-item">
                        <i class="fas fa-check-circle"></i>
                        {{ \App\Models\Asistencia::whereHas('inscripcion.seccion', function($q) {
                            $q->where('profesor_id', auth()->user()->profesor->id);
                        })->count() }} Registros
                    </span>
                </div>
            ...
            <div class="report-actions">
                <a href="{{ route('profesor.reportes.asistencias') }}" class="btn-neon-sm">
                    <i class="fas fa-eye me-2"></i>Ver Reporte
                </a>
            </div>
        </div>

        <!-- Reporte de Rendimiento por Sección -->
        <div class="report-card">
            ...
            <div class="report-content">
                ...
                <p>Análisis de aprobación y rendimiento por materia y sección</p>
                <div class="report-stats">
                    <span class="stat-item">
                        <i class="fas fa-chalkboard"></i>
                        {{ auth()->user()->profesor->secciones->count() }} Secciones
                    </span>
                </div>
            </div>
            <div class="report-actions">
                <a href="{{ route('profesor.reportes.rendimiento') }}" class="btn-neon-sm">
                    <i class="fas fa-eye me-2"></i>Ver Reporte
                </a>
            </div>
        </div>
        ...
        <div class="report-card">
            ...
            <div class="report-content">
                ...
                <p>Resumen de evaluaciones creadas y estadísticas de participación</p>
                <div class="report-stats">
                    <span class="stat-item">
                        <i class="fas fa-tasks"></i>
                        {{ \App\Models\Evaluacion::whereHas('seccion', function($q) {
                            $q->where('profesor_id', auth()->user()->profesor->id);
                        })->count() }} Evaluaciones
                    </span>
                </div>
            ...
            <div class="report-actions">
                <a href="{{ route('profesor.reportes.evaluaciones') }}" class="btn-neon-sm">
                    <i class="fas fa-eye me-2"></i>Ver Reporte
                </a>
            </div>
        </div>
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <div class="quick-action-card">
                    ...
                    <div class="quick-content">
                        ...
                        <p>Genera reportes en PDF o Excel de tus secciones</p>
                    </div>
            ...
            <div class="col-md-6">
                <div class="quick-action-card">
                    ...
                    <a href="{{ route('profesor.secciones.index') }}" class="btn-outline-neon-sm">
        ...
        <div class="modal-content modal-dark">
            ...
            <div class="modal-body">
                <form method="GET" id="exportForm">
                    ...
                    <div class="mb-3">
                        <label class="form-label-dark">Sección (opcional)</label>
                        <select name="seccion_id" class="form-select-dark">
                            <option value="">Todas las secciones</option>
                            @foreach(auth()->user()->profesor->secciones as $seccion)
                                <option value="{{ $seccion->id }}">{{ $seccion->codigo_seccion }} - {{ $seccion->curso->nombre }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
...
<script>
    function exportarReporte() {
        ...
        const seccionId = form.querySelector('[name="seccion_id"]').value;
        ...
        let url = `{{ route('profesor.reportes.exportar-pdf') }}?tipo=${tipo}&formato=${formato}`;
        if (seccionId) {
