    ...
    <div class="row g-4">
                ...
                <div class="card-body-dark text-center">
                    <div class="profile-photo-container">
                        @if($estudiante->foto_perfil)
                            <img src="{{ asset('storage/' . $estudiante->foto_perfil) }}" alt="Foto de perfil" class="profile-photo">
                        @else
                    ...
                    <h4 class="profile-name">{{ $estudiante->nombre_completo }}</h4>
                    ...
                    <div class="profile-actions">
                        ...
                        @if($estudiante->foto_perfil)
                            <form action="{{ route('estudiante.perfil.eliminar-foto') }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
            ...
            <div class="card-dark">
                ...
                <div class="card-body-dark">
                    <div class="stat-item">
                        ...
                        <div class="stat-info">
                            <h5>{{ $stats['total_inscripciones'] }}</h5>
                            <p>Total Materias</p>
                        </div>
                    </div>
                    ...
                    <div class="stat-item">
                        ...
                        <div class="stat-info">
                            <h5>{{ $stats['materias_aprobadas'] }}</h5>
                    ...
                    <div class="stat-item">
                        ...
                        <div class="stat-info">
                            <h5>{{ $stats['creditos_acumulados'] }}</h5>
                    ...
                    <div class="stat-item">
                        ...
                        <div class="stat-info">
                            <h5>{{ $stats['promedio_general'] ? number_format($stats['promedio_general'], 2) : 'N/A' }}</h5>
        ...
        <div class="col-lg-8">
                    ...
                    <form action="{{ route('estudiante.perfil.update') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control-neon" value="{{ $estudiante->nombre_completo }}" disabled>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label-neon">DNI</label>
                                <input type="text" class="form-control-neon" value="{{ $estudiante->dni }}" disabled>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control-neon" value="{{ $estudiante->genero ?? 'No especificado' }}" disabled>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="direccion" class="form-control-neon @error('direccion') is-invalid @enderror" 
                                          rows="2">{{ old('direccion', $estudiante->direccion) }}</textarea>
                                @error('direccion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div class="card-dark">
                ...
                <div class="card-body-dark">
                    <form action="{{ route('estudiante.perfil.cambiar-password') }}" method="POST">
                        @csrf
                        @method('PUT')
...
<div class="modal fade" id="modalFoto" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content modal-dark">
            ...
            <form action="{{ route('estudiante.perfil.subir-foto') }}" method="POST" enctype="multipart/form-data">
                @csrf
