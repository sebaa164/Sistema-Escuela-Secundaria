...
@endphp
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select-dark-lg @error('tipo_usuario') is-invalid @enderror"
                                        id="tipo_usuario"
                                        name="tipo_usuario_display"
                                        {{ $usuario->tipo_usuario === 'estudiante' ? 'disabled' : '' }}
                                        required>
                                ...
                                @if($usuario->tipo_usuario === 'estudiante')
                                    ...
                                    <small class="form-text-dark" style="color: #10b981;">
                                        <i class="fas fa-lock me-1"></i>El tipo de usuario estudiante no se puede cambiar
                                    </small>
                                @endif
                                @error('tipo_usuario')
                                    <div class="invalid-feedback-dark">
