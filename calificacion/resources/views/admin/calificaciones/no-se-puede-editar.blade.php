...
@section('title', 'No se puede editar')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="alert alert-danger-neon mb-4">
                <h4><i class="fas fa-lock me-2"></i>No se puede editar esta calificación</h4>
                <p class="mb-0">Esta calificación tiene datos incompletos y no puede ser editada hasta que se resuelvan los problemas.</p>
            </div>
            ...
            <div class="card-dark">
                ...
                <div class="card-body-dark">
                    ...
                    <div class="section-header mb-4">
                        ...
                        <h6>Problemas que impiden la edición</h6>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="info-box">
                                <label>Fecha:</label>
                                <p>{{ $calificacion->fecha_calificacion ? $calificacion->fecha_calificacion->format('d/m/Y') : 'No registrada' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <a href="{{ route('admin.calificaciones.show', $calificacion) }}" class="btn-outline-neon">
...
@push('styles')
<style>
    /* Reutilizar los mismos estilos de show-con-problemas.blade.php */
    .alert-danger-neon {
