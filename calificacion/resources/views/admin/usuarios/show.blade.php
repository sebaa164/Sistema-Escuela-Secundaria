...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
                                    ...
                                    @if($usuario->tipo_usuario === 'estudiante')
                                        @if($usuario->estado_estudiante === 'regular')
                                            <span class="badge-status status-active">
                                                <i class="fas fa-check-circle me-1"></i>Regular
                                            </span>
                                        ...
                                        @elseif($usuario->estado_estudiante === 'libre')
                                            <span class="badge-status status-inactive">
                                                <i class="fas fa-pause-circle me-1"></i>Libre
                                            </span>
                                        @elseif($usuario->estado_estudiante === 'preinscripto')
                                            <span class="badge-status status-pending">
                                                <i class="fas fa-clock me-1"></i>Preinscripto
                                            </span>
                                        @else
                                            <span class="badge-status status-inactive">
                                                <i class="fas fa-circle me-1"></i>Sin estado
                                            </span>
                                        @endif
                                    @else
            ...
            <!-- Información del Tutor/Representante - Solo para Estudiantes -->
            @if($usuario->tipo_usuario === 'estudiante' && isset($tutor))
                <div class="card-dark mb-4">
                    <div class="card-header-dark">
                        <h5 class="mb-0">
                    ...
                    <div class="card-body-dark">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="info-item">
                                    <label class="info-label">
                                        <i class="fas fa-user-friends me-2"></i>Parentesco
                                    </label>
                                    <p class="info-value">
                                        @switch($tutor->parentesco ?? '')
                                            @case('padre')
                                                <span class="badge-info">Padre</span>
                                                @break
                                            @case('madre')
                                                <span class="badge-info">Madre</span>
                                                @break
                                            @case('tutor')
                                                <span class="badge-info">Tutor</span>
                                                @break
                                            @case('abuelo')
                                                <span class="badge-info">Abuelo/Abuela</span>
                                                @break
                                            @case('tio')
                                                <span class="badge-info">Tío/Tía</span>
                                                @break
                                            @case('otro')
                                                <span class="badge-info">Otro</span>
                                                @break
                                            @default
                            ...
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <p class="info-value">
                                        ...
                                        @if(!isset($tutor->nombre) || empty($tutor->nombre))
                                            <span class="text-muted">No especificado</span>
                                        @endif
                                    </p>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <p class="info-value">{{ $tutor->telefono ?? 'No especificado' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <p class="info-value">{{ $tutor->email ?? 'No especificado' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
