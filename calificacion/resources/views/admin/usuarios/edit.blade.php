        ...
        <div class="col-lg-10">
            <div class="card-dark">
                ...
                <div class="card-body-dark">
                    <form method="POST" action="{{ route('admin.usuarios.update', $usuario) }}" id="editUserForm" autocomplete="off" novalidate>
                        @csrf
                        @method('PUT')
...
@endphp
                            ...
                            <div class="col-md-6" id="campo_estado_general" style="{{ $usuario->tipo_usuario === 'estudiante' ? 'display: none;' : 'display: block;' }}">
                                ...
                                <select class="form-select-dark-lg @error('estado') is-invalid @enderror" 
                                        id="estado" 
                                        name="estado"
                                        @if($usuario->tipo_usuario !== 'estudiante') required @endif>
...
function mostrarError(input, mensaje) {
    const feedbackDiv = input.parentNode.querySelector('.invalid-feedback-dark');
    if (feedbackDiv) {
...
function ocultarError(input) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Configurar campos de estudiante inicialmente
        ...
        form.addEventListener('submit', function(e) {
            ...
            // Validar lógica adicional (contraseñas si se cambió)
        ...
        if (tipoUsuarioSelect.value === 'estudiante') {
            ...
            configurarCamposRepresentante(true);
            console.log('Inicialización edit: estudiante ya seleccionado, mostrando campos');
        } else {
            console.log('Inicialización edit: tipo de usuario no es estudiante');
        }
