...
Route::put('perfil/password', [App\Http\Controllers\Admin\PerfilController::class, 'cambiarPassword'])->name('perfil.cambiar-password');
Route::post('perfil/foto', [App\Http\Controllers\Admin\PerfilController::class, 'subirFoto'])->name('perfil.subir-foto');
Route::delete('perfil/foto', [App\Http\Controllers\Admin\PerfilController::class, 'eliminarFoto'])->name('perfil.eliminar-foto');
});
/*
|--------------------------------------------------------------------------
| RUTAS DEL PROFESOR
