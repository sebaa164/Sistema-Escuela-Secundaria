...
class EvaluacionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $evaluacion = Evaluacion::create([
                ...
                'porcentaje' => $validated['porcentaje'] ?? null,
    ...
    public function show(Evaluacion $evaluacion)
    {
        ...
        // Estadísticas de la evaluación (null-safe para seccion)
        $stats = [
            'total_estudiantes' => $evaluacion->seccion
                ? $evaluacion->seccion->inscripciones()->where('estado', 'inscrito')->count()
                : 0,
